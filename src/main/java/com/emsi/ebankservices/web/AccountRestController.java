package com.emsi.ebankservices.web;
...
import com.emsi.ebankservices.services.AccountService;
...
public class AccountRestController {
    ...
    public BankAccount update(@PathVariable String id,@RequestBody BankAccount bankAccount){
        ...
        if(bankAccount.getSolde()!=null)  account.setSolde(bankAccount.getSolde());
